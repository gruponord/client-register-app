...
// El orden y las omisiones vienen en `presentacion`, igual que en el PDF.
const importes = (linea, prefijo) =>
  (linea.presentacion || []).map((x) => ({
    v: linea[prefijo + x.campo],
    suf: x.sufijo,
